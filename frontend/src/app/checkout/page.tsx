        ...
        <div className="lg:col-span-2">
              ...
              <div className="space-y-4">
                <label className="flex items-center justify-between p-4 border border-zinc-200 dark:border-white/20 cursor-pointer hover:border-[#ff0033] dark:hover:border-[#ff0033] transition-colors rounded-lg bg-zinc-50 dark:bg-transparent">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="font-poppins text-zinc-800 dark:text-white">Razorpay (Cards, UPI, NetBanking)</span>
                  </div>
          ...
          {step === 3 && (
            <div className="space-y-8 text-center py-10">
              ...
              <p className="text-zinc-600 dark:text-gray-400 font-poppins text-lg">Your order has been confirmed and is being processed.</p>
